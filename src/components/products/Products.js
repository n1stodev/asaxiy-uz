                    ...
                    <div className="pro__card" key={item.id}>
                            ...
                            <div className="pro__img-btns">
                                {
                                    admin
                                        ...
                                        :
                                        <AiOutlineShoppingCart className='pro__img4' onClick={() => dispatch(addToCart(item))} />
                                }
                                {
                                    like
                                        ?
                        ...
                        <div className="pro__body">
                            ...
                            <div className="pro__card-price">
                                ...
                                <p>{item.price} so'm</p>
                                <span className='pro__card-monthly'>{Math.round(item.price * 1.5 / 12)} so'm / 12 oy</span>
                            </div>
